...
Keys = Sprite:extend{
    ...
    keyPressed = function (self, key)
        ...
        -- yea, this is naive, and fails when you use 
        -- modifiers like ctrl with a key. But works for the 
        -- moment. If Moai is to be used for desktop, we'll 
        -- most likely roll up our own Host, so the way key callbacks
        -- work may be completely different.
        key = string.char(tostring(key))
